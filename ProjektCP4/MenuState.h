...
public:
	MenuState(sf::RenderWindow* window, std::stack<State*> *States); // constructor, calls all the private functions
	virtual ~MenuState(); // destructor, deletes created buttons in the map
